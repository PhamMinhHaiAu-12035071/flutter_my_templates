...
const ItemShowSuggestSuccess = (props) => {
    ...
    return (react_1.default.createElement(CustomSpinner_1.CustomSpinner, { spinner: itemType, arrText: [react_1.default.createElement(ink_1.Text, { ...styledText }, constants_1.SPACE_CHARACTER + props.name + constants_1.SPACE_CHARACTER)] }));
};

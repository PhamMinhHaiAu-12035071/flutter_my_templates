...
export declare const setPathSuccess: import("@reduxjs/toolkit").ActionCreatorWithPayload<string, string>, setPathFailed: import("@reduxjs/toolkit").ActionCreatorWithPayload<ValidationError[], string>, setPathLoading: import("@reduxjs/toolkit").ActionCreatorWithoutPayload<string>;

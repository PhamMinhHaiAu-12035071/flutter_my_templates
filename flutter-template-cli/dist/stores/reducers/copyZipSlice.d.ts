...
export declare const setCopyZipFlutterLoading: import("@reduxjs/toolkit").ActionCreatorWithoutPayload<string>, setCopyZipFlutterSuccess: import("@reduxjs/toolkit").ActionCreatorWithPayload<string, string>, setProgress: import("@reduxjs/toolkit").ActionCreatorWithPayload<RsyncProgressData, string>;

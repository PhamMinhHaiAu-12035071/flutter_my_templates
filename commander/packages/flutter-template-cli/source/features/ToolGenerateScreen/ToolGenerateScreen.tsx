...
const ToolGenerateScreen = (): React.ReactElement | null => {
	const [screen, changeScreen] = React.useState<TOOL_GENERATE_PATH>(TOOL_GENERATE_PATH.QUESTION_INSTALL_FLUTTER_SCREEN);

	return (
		<ToolGenerateRouterContext.Provider value={{
			screenName: screen,
